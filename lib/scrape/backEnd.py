...
def ask_how_are_you():
    ...
    completion = client.chat.completions.create(
        ...
        messages=[{
            "role": "user",
            "content": f"Provide BPM and Energy of a song in format BPM:<BPM> , Energy: <Energy>. NO TEXT AT ALL! (scale from 0-100) for song with spotify ID, {track_id}. If you don't know, make a guess."
        }]
    )
